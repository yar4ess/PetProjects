...
public class Enter {
     ...
     */
    public static Movie enterMovie(Console console) throws EnterBreak{
        try {
            double budget;
            String tagline;
            String name;
            ...
            return new Movie(1234, name, coordinates, new Date(), oscarsCount, budget, tagline, genre, screenwriter);
